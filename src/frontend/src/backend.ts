...
export class Backend implements backendInterface {
    ...
    async addScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTopScores(arg0: bigint): Promise<Array<[Principal, Score]>> {
        if (this.processError) {
            try {
    ...
    async resetScore(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetScore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
